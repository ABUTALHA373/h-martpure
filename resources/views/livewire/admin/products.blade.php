<div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <tr class="hover:bg-bg-secondary/50 transition-colors group">
                    <td class="w-8 pl-6 pr-3 py-4 text-text-secondary">{{$k+1}}</td>
                    ...
                    <td class="px-3 py-4 text-text-secondary">{{$product->slug}}</td>
                    <td class="px-3 py-4 text-text-secondary">{{$product->brand}}</td>
                    <td class="px-3 py-4 text-text-secondary">{{$product->category->name}}</td>
                    <td class="px-3 py-4 text-text-secondary">{{$product->measurement . " ". $product->measurement_unit}}</td>
                    <td class="px-3 py-4 text-text-secondary">{{$product->sales_count}}</td>
                    <td class="px-3 py-4">
    ...
    @if($showDetailModal && $selectedProduct)
        ...
        <x-others.modal>
            ...
            <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-8 flex-1 overflow-y-auto">
                {{-- Image Gallery --}}
                <div class="space-y-4">
